...
export default class SubjectView extends React.Component {
    render() {
        return (React.createElement(View, {style: [stylesheet['subject-view-container']]}, React.createElement(View, {style: stylesheet.headerContainer}, React.createElement(Text, {style: stylesheet.headerText}, this.props.subject)), !this.props.showPlaceholderForCostlyElements &&
            React.createElement(StaggeredListView, null, [0, 1, 2, 3, 4, 5].map(month => React.createElement(View, {key: `month${month}`, style: stylesheet.calenderContainer}, React.createElement(Text, {style: { fontWeight: '900', fontSize: 18, textAlign: 'center', lineHeight: 30 }}, SubjectView.months[month]), React.createElement(CalendarMonthView, {month: month, year: 2016, initialActiveDays: this.props.attendanceRecord[month].map((day, d) => day === 0 ? d : null).filter(d => d !== null), activeDayColor: undefined}))))));
    }
}
SubjectView.months = [
    'January',
